...
const optionsLivre = {
  emprunterLivre() {
    console.log("Livre qui peut être emprunté");
  },

  acheterLivre() {
    console.log("Livre qui peut être vendu");
  },
};

Object.assign(Livre.prototype, optionsLivre); //mixin
let monLivre2 = new Livre("La tour sombre 2", "Stephen King", 490);

monLivre2.emprunterLivre();
monLivre2.acheterLivre();
